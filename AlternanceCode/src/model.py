...
class Down(nn.Module):
    """
    Downsampling block with MaxPool3d followed by two Conv3D-BatchNorm-ReLU layers with dropout.
    """
...
class Up(nn.Module):
    """
    Upsampling block with trilinear interpolation followed by two Conv3D-BatchNorm-ReLU layers with dropout.
    Concatenates the corresponding skip connection from the downsampling path.
    """
